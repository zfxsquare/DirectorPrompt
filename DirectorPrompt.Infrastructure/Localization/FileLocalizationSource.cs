...
) : ILocalizationSource
{
    ...
    public IReadOnlyList<string> DiscoverLanguages()
    {
    ...
    public bool Exists(string language, string resourceName)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(resourceName);
        return File.Exists(GetFilePath(resourceName));
    }

    public Stream? OpenRead(string language, string resourceName)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(resourceName);
